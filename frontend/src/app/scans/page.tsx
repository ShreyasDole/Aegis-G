          ...
          <div className="col-span-12 lg:col-span-7">
            <Card className="h-full flex flex-col">
              <div className="flex justify-between items-center mb-4">
                <h2 className="text-xs font-bold text-success tracking-widest uppercase">Scan Results</h2>
              </div>
              ...
              <div className="flex-1 space-y-3 overflow-y-auto pr-2 scrollbar-thin max-h-[500px]">
                {liveScans.length === 0 ? (
                  <div className="text-center py-20 text-text-muted italic">
                    Run a manual scan above to see results here.
                  </div>
                ) : (
                  liveScans.map((scan) => (
                    <div key={scan.id} className="bg-bg-primary border border-border-subtle p-4 rounded hover:border-primary/50 transition-all">
